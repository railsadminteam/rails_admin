  ...
  $(document).on('rails_admin.dom_ready', function(e, content) {
    ...
    if (content.length) {
      ...
      content.find('[data-fileupload]').each(function() {
        ...
        return parent.find('.btn-remove-image').on('click', function() {
      ...
      content.find('[data-multiple-fileupload]').each(function() {
        return $(this).closest('.controls').find('.btn-remove-image').on('click', function() {
          $(this).siblings('[type=checkbox]').click();
      ...
      content.find('[data-polymorphic]').each(function() {
        ...
        return type_select.on('change', function(e) {
          ...
          return object_select.filteringSelect(selected_data);
        });
      });
      ...
      goFroalaWysiwygs = (function(_this) {
        return function(array) {
          return array.each(function() {
            ...
            if (uploadEnabled) {
              return $(this).on('froalaEditor.image.error', function(e, editor, error) {

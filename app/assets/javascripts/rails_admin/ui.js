...
(function() {
  ...
  $(document).on('rails_admin.dom_ready', function() {
    ...
    return $.each($('#filters_box').data('options'), function() {
      return $.filters.append(this);
    });
  });
  ...
  $(document).on('click', '#fields_to_export .reverse-selection', function() {
    return $(this).closest(".control-group").find(".controls").find("input").click();
  });

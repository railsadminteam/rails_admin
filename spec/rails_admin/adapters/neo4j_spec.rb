...
RSpec.describe 'RailsAdmin::Adapters::Neo4j', neo4j: true do
  describe '#associations' do
    it 'returns Association class' do
      expect(RailsAdmin::AbstractModel.new(Player).associations.first).
        to be_a_kind_of RailsAdmin::Adapters::Neo4j::Association
    end
  end
  ...
  describe '#properties' do
    it 'returns Property class' do
      expect(RailsAdmin::AbstractModel.new(Player).properties.first).
        to be_a_kind_of RailsAdmin::Adapters::Neo4j::Property
    end
  end
  ...
  describe 'data access methods' do
    ...
    describe '#all' do
      ...
      it 'supports pagination' do
        ...
        # To prevent RSpec matcher to call Neo4j::Criteria#== method,
        # (we want to test equality of query result, not of Neo4j criteria)
        # to_a is added to invoke Neo4j query
      end
  ...
  describe 'model attribute method' do
    ...
    it '#scoped returns relation object' do
      expect(@abstract_model.scoped).to be_instance_of(Neo4j::Criteria)
    end

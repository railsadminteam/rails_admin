  ...
  describe 'filters' do
    ...
    context 'on dates' do
      it 'lists elements within outbound limits' do
        ...
        expect(@abstract_model.all(filters: {'date_field' => {'1' => {v: ['', '02 January 2012', '03 January 2012'], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'date_field' => {'1' => {v: ['', '02 January 2012', '02 January 2012'], o: 'between'}}}).count).to eq(1)
        expect(@abstract_model.all(filters: {'date_field' => {'1' => {v: ['', '03 January 2012', ''], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'date_field' => {'1' => {v: ['', '', '02 January 2012'], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'date_field' => {'1' => {v: ['02 January 2012'], o: 'default'}}}).count).to eq(1)
      end
    end
    ...
    context 'on datetimes' do
      it 'lists elements within outbound limits' do
        ...
        expect(@abstract_model.all(filters: {'datetime_field' => {'1' => {v: ['', '02 January 2012', '03 January 2012'], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'datetime_field' => {'1' => {v: ['', '02 January 2012', '02 January 2012'], o: 'between'}}}).count).to eq(1)
        expect(@abstract_model.all(filters: {'datetime_field' => {'1' => {v: ['', '03 January 2012', ''], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'datetime_field' => {'1' => {v: ['', '', '02 January 2012'], o: 'between'}}}).count).to eq(2)
        expect(@abstract_model.all(filters: {'datetime_field' => {'1' => {v: ['02 January 2012'], o: 'default'}}}).count).to eq(1)
      end
    end
  end

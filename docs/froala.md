...
1. Add Froala's assets gem.
   ...
   _Note:_ This functionality is currently available in the master branches of both `rails_admin` and `froala/wysiwyg-rails`, but neither gem has released a version with these features. For now, we'll need to use specific revisions of these gems from GitHub:

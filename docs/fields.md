...
Borrowing from [Models#configuring-models-all-at-once](models.md#configuring-models-all-at-once), you can use the following to make fields read-only by default:
